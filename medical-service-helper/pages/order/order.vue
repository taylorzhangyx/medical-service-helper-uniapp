    ...
    <view>
        ...
        <view class="order-status">
            ...
            <block v-if="orderStatus == 10">
                ...
                <view class="od-op">
                    <button class="btnp"
                            @click="dopay">立即支付（{{ order.price }}元）</button>
                </view>
            </block>
            <!-- 进行中 -->
            ...
            <view class="od-box">
                <view class="weui-cells">
                    ...
                    <view class="weui-cell od-staff">
                        <view class="weui-cell__hd">
                            <view>
                                <image :src="order._staff.avatar_url"
                                       mode="aspectFill"
                        ...
                        <view class="weui-cell__ft">
                            <view>
                                <button class="btn1m"
                                        @tap="makePhoneCall"
                                        :data-tel="order._staff.mobile">电话联系</button>
                            </view>
                        </view>
                    </view>
                </view>
            ...
            <view class="weui-cells">
                ...
                <block v-if="order.service_stype <= 20">
                    ...
                    <view class="weui-cell">
                        ...
                        <view class="weui-cell__ft">
                            <view>
                                <formater :timestamp="order.starttime"
                                          format="YYYY-MM-dd hh:mm"></formater>
                            </view>
                        </view>
                    </view>
                    <view class="weui-cell">
        ...
        <view class="od-box">
            <view class="weui-cells">
                ...
                <view class="weui-cell">
                    ...
                    <view class="weui-cell__ft">
                        <view>
                            <formater :timestamp="order.order_start_time"
                                      format="YYYY-MM-dd hh:mm"></formater>
                        </view>
                    </view>
                </view>
                ...
                <block v-if="orderStatus == 20">
                    ...
                    <view class="weui-cell">
                        ...
                        <view class="weui-cell__ft">
                            <view>
                                <formater :timestamp="order.pay_time"
                                          format="YYYY-MM-dd hh:mm"></formater>
                            </view>
                        </view>
                    </view>
...
<script setup>
    ...
    const orderStatus = computed(() => {
        ...
        return order.value ? map[order.value.trade_state] : 0
    })
    ...
    const getOrderDetail = (params) => {
        app.globalData.utils.request({
            ...
            success: (success) => {
                console.log("get order detail success", success)
