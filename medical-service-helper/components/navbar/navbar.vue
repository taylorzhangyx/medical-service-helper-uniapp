view<template>
    <view class="nav">
        <view class="statusbar"
              :style="'height:' + statusHeight + 'rpx;' + containerStyle"></view>
        <view v-if="isHome"
              class="headNav"
            ...
            <view style="flex:1">
                <navigator url="../../pages/search/index"
                           :style="'height:' + menu.height * 2 + 'rpx; line-height:' + menu.height * 2 + 'rpx;margin-top:' + (menu.top * 2 - statusHeight) + 'rpx; margin-left: 32rpx; margin-right:' + (menu.width * 2 + 24) + 'rpx; background: #f4f4f4; border-radius: 200rpx; text-align:center'"
                           open-type="navigate"
...
const setMenu = () => {
    ...
    if (system.indexOf('iOS') > -1) {
        menu = reactive(uni.getMenuButtonBoundingClientRect())
    } else {
